...
!defined('LSCWP_DEBUG_ACTIONS_FUNCTIONS') && define('LSCWP_DEBUG_ACTIONS_FUNCTIONS', [
    ...
    'redetect_image_node' => [ 'function' => 'redetect_image_node', 'self_nonce' => true, 'message_ok' => 'Image optimization node updated', 'message_error' => 'Failed to update image optimization node' ],
    'redetect_page_node' => [ 'function' => 'redetect_page_node', 'self_nonce' => true, 'message_ok' => 'Page optimization node updated', 'message_error' => 'Failed to update page optimization node' ],
    'reset_ttl' => [ 'function' => 'reset_ttl', 'self_nonce' => true, 'message_ok' => 'Page optimization services TTL reset', 'message_error' => 'Failed to reset TTL' ],                                                                                         
]);
